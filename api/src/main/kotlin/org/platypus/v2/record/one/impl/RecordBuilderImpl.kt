...
class RecordBuilderImpl<M : BaseModel<M>>(override val env: PlatypusEnvironment, initData: Map<BaseField<M, *>, Any?>) : RecordBuilder<M> {
    ...
    override fun IntField<M>.setValue(o: RecordField<M>, desc: KProperty<*>, value: Int?) {
        data[this] = value
    }

    override fun StringField<M>.setValue(o: RecordField<M>, desc: KProperty<*>, value: String?) {
        data[this] = value
    }

    override fun <D : Selection<D>> SelectionField<M, D>.setValue(o: RecordField<M>, desc: KProperty<*>, value: SelectionValue<D>?) {
        data[this] = value
    }

    override fun TextField<M>.setValue(o: RecordField<M>, desc: KProperty<*>, value: String?) {
        data[this] = value
    }

    override fun DateField<M>.setValue(o: RecordField<M>, desc: KProperty<*>, value: LocalDate?) {
        data[this] = value
    }

    override fun DateTimeField<M>.setValue(o: RecordField<M>, desc: KProperty<*>, value: LocalDateTime?) {
        data[this] = value
    }

    override fun TimeField<M>.setValue(o: RecordField<M>, desc: KProperty<*>, value: LocalTime?) {
        data[this] = value
    }

    override fun BooleanField<M>.setValue(o: RecordField<M>, desc: KProperty<*>, value: Boolean?) {
        data[this] = value
    }

    override fun DecimalField<M>.setValue(o: RecordField<M>, desc: KProperty<*>, value: BigDecimal?) {
        data[this] = value
    }

    override fun BinaryField<M>.setValue(o: RecordField<M>, desc: KProperty<*>, value: ByteArray?) {
        data[this] = value
    }

    override fun <TM : BaseModel<TM>> Many2OneField<M, TM>.setValue(o: RecordField<M>, desc: KProperty<*>, value: Record<TM>?) {
        data[this] = value?.id
    }

    override fun <TM : BaseModel<TM>> One2ManyField<M, TM>.setValue(o: RecordField<M>, desc: KProperty<*>, value: Iterable<Record<TM>>) {
        data[this] = value.ids
    }

    override fun <TM : BaseModel<TM>> Many2ManyField<M, TM>.setValue(o: RecordField<M>, desc: KProperty<*>, value: Iterable<Record<TM>>) {
        data[this] = value.ids
    }
    ...
    override fun <TM : BaseModel<TM>> One2ManyField<M, TM>.getValue(o: ImmutableRecordField<M>, desc: KProperty<*>): Bag<TM> {
        return BagRecordImpl(env, this.target, data.getOrDefault(this, emptyList<Int>()) as List<Int>)
    }
    ...
    override fun <TM : BaseModel<TM>> Many2OneField<M, TM>.getValue(o: ImmutableRecordField<M>, desc: KProperty<*>): Record<TM> {
        return RecordImpl(env, data[this] as Int, this.target)
    }
}